                    ...
                    <div class="wallet-inner">
                        <div class="wallet-content">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="tabe-menu">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link wallet {{($active == 'deposit') ? 'active' : ''}}" id="diposite-tab" href="{{route('walletDetails',$wallet->id)}}?q=deposit" aria-controls="diposite" aria-selected="true">
                                                        <i class="flaticon-wallet"></i> {{__('Deposit')}}
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link send  {{($active == 'withdraw') ? 'active' : ''}}" id="withdraw-tab" href="{{route('walletDetails',$wallet->id)}}?q=withdraw" aria-controls="withdraw" aria-selected="false">
                                                        <i class="flaticon-send"> </i> {{__('Withdraw')}}
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link share  {{($active == 'activity') ? 'active' : ''}}" id="activity-tab" href="{{route('walletDetails',$wallet->id)}}?q=activity" aria-controls="activity" aria-selected="false">
                                                        <i class="flaticon-share"> </i> {{__('Activity')}}
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade   {{($active == 'deposit') ? 'show active' : ''}} in" id="diposite" role="tabpanel"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="tabcontent-right">
                                                ...
                                                <div class="aenerate-address">
                                                    <a href="{{route('generateNewAddress')}}?wallet_id={{$wallet_id}}">
                                        ...
                                        <div class="col-lg-6 offset-lg-3">
                                            <div class="form-area">
                                                <form action="{{route('WithdrawBalance')}}" method="post" id="withdrawFormData">
                                                    ...
                                                    <button onclick="withDrawBalance()" type="button" class="primary-btn">{{__('Submit')}}</button>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="activity-right text-right">
                                                                <ul class="nav nav-tabs">
                                                                    <li class="active"><a data-toggle="tab" onclick="$('#list_title').html('All Deposit List')" data-title=""  href="#Deposit">{{__('Deposit')}}</a></li>
                                                                    <li><a data-toggle="tab" onclick="$('#list_title').html('All Withdrawal List')"  href="#Withdraw">{{__('Withdraw')}}</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
