...
@section('content')
    <!-- header-area end -->
    @include('backend.widget.admin-header',['title'=>__('Email Pending')])
    <!-- header-area end -->
    <!-- .user-area start -->
    <div class="user-area">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="admin-wrapper">
                        <h3 class="subtitle">{{__('Email Pending')}}</h3>
                        <ul class="nav user-menu">
                            ...
                            <li><a class="active" href="{{route('adminPendingUsers')}}">{{__('Email Pending')}}</a></li>
                        </ul>
                        <!-- user-area start-->
