...
@section('title',__('Suspended User'))
@section('content')
    <!-- header-area end -->
    @include('backend.widget.admin-header',['title'=>__('Suspended User')])
    <!-- header-area end -->
    <!-- .user-area start -->
    <div class="user-area">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="admin-wrapper">
                        <h3 class="subtitle">{{__('Suspended User')}}</h3>
                        <ul class="nav user-menu">
                            ...
                            <li><a class="active" href="{{route('adminSuspendedUsers')}}">{{__('Suspended User')}}</a></li>
...
@section('script')
    <script>
        $('#table').DataTable({
            ...
            bLengthChange:true,
            responsive: true,
            ajax:'{{route('adminSuspendedUsers')}}',
            order:[3,'desc'],
            autoWidth:false,
            language: {
                paginate: {
