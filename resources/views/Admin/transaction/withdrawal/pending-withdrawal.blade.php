...
@section('title',__('Pending Withdrawal'))
@section('style')
@endsection
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="breadcrumb-area">
                            <ul>
                                <li class="page " >{{__('Pending withdrawal')}}</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-3 text-right acsmrightbtn">
                        <a class="witrowal-btn" href="{{route('adminRejectedWithdrawal')}}">{{__('Rejected Withdrawal Histories')}}</a>
                    </div>
                </div>
